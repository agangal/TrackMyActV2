...
namespace TrackMyActV2.Libraries
{
    public class Library
    {
        ...
        public async Task<string> readFile(string filename)
        {
            ...
            var localFolder = applicationData.RoamingFolder;
        ...
        {            
            string res = (((seconds / 3600) > 0) ? ((seconds / 3600).ToString() + " h ") : "") + ((((seconds / 60) % 60) > 0) ? (((seconds / 60) % 60).ToString() + " m ") : "") + (((seconds % 60) >= 0) ? ((seconds % 60).ToString() + " sec") : "");
            return res;
        }
        /// <summary>
        ...
        public async void deleteFile(string filename)
        {
            ...
            {
                StorageFile sampleFile = await ApplicationData.Current.RoamingFolder.GetFileAsync(filename);
